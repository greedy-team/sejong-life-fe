...
interface ProfileCardProps {
  myProfile: UserProfileResponseProps;
}

const ProfileCard = ({ myProfile }: ProfileCardProps) => {
  return (
        ...
        <div className="flex flex-col lg:gap-2">
          <div className="flex gap-3">
            ...
            <div className="lg:text-2xl">
              {myProfile && myProfile.studentId}
            </div>
          </div>
          <div className="flex gap-3">
            <div className="lg:text-2xl">학과:</div>
            <div className="lg:text-2xl">
              {myProfile && myProfile.department}
            </div>
          </div>
        </div>
      </div>
